...
//                }
            ...
            if(msg){
                var msgDiv=$('<div style="position:absolute;padding:2px;background:#ccca"><div style="line-height:50px;height:50px;border:#a3bad9 1px solid;background:white;padding:2px 10px 2px 10px"><img style="display: inline;float: left;margin: 10px 15px;" src="resources/images/loading.gif">'+msg+'</div></div>');
