    ...
    if(newVal==null){
    	...
    	if(newVal.ziDuanLXDH == 'string'){//字符
	    	if(ziDuanCDField.getValue()==null){
	      		ziDuanCDField.setValue(newVal.ziDuanKD,true);
	      	}
			guanLianSTLField.setValue(null,true);
	      	guanLianFLZDField.setValue(null,true);
			...
			guanLianSTLField.setValue(null,true);
	     	...
	     	guanLianFLZDField.disable();
	      	...
	      	if(ziDuanJDField.getValue()==null){
	      		ziDuanJDField.setValue(newVal.ziDuanJD,true);
	      	}
			guanLianSTLField.setValue(null,true);
	      	guanLianFLZDField.setValue(null,true);
			...
			guanLianSTLField.setValue(null,true);
	     	...
	     	guanLianFLZDField.disable();
	      	...
	      	ziDuanCDField.setValue(null,true);
	      	ziDuanJDField.setValue(null,true);
